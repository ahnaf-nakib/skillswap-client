...
const Footer = () => {
    return (
        <footer className="footer sm:footer-horizontal bg-gray-900 text-gray-300 p-10 rounded-t-xl">
            ...
            <nav className="flex flex-col items-center sm:items-end mt-6 sm:mt-0">
